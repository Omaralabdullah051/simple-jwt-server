...
app.post('/login', (req, res) => {
    ...
    //After completing all authentication related verification, issue JWT token(because here we don't implement firebase. that's why we need to authenticate the user first)
